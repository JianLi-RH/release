...
# you can get model API from https://gitlab.cee.redhat.com/models-corp/user-documentation/-/tree/main/models
# you can get the token from your personal models.corp environment: https://developer.models.corp.redhat.com/admin/applications
models = {
    "granite":{
    ...
    "mxbai":{
        "url": "https://mxbai-embed-large-v1--apicast-production.apps.int.stc.ai.prod.us-east-1.aws.paas.redhat.com/v1/chat/completions",
        "token": "",
        "model": "mxbai-embed-large-v1"
    },
    "MiniLM":{
        "url": "https://all-minilm-l6-v2--apicast-production.apps.int.stc.ai.prod.us-east-1.aws.paas.redhat.com/v1/chat/completions",
        "token": "",
...
if __name__ == '__main__':
    ...
    question = "Please sort the tests elements by 'as' field in below yaml file and give me the full file"
    ask_me(question=question, modelName=model)
